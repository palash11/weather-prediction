$(document).ready(function(){
  $('.sb').click(function(){
    var city = document.getElementById('#slist');
    var valgrp = city.option[city.selectedIndex].text;
    var country = document.getElementById('#sclist');
    var coungrp = country.option[country.selectedIndex].text;
    $.ajax({
      url: 'http://api.wunderground.com/api/4362c51d1d1e3e4c/forecast/q/'+ coungrp + '/' + valgrp + '.json',
      type: "GET",
      dataType: "jsonp",
