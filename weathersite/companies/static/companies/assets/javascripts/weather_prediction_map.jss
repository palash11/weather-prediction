...
function initialize() {
  ...
  $.ajax({
    url: "https://api.darksky.net/forecast/1f961992ec2e2db9112cf57ade593090/"+19.0760+","+-72.8777,
    xhrFields: {
  ...
  google.maps.event.addListener(map, 'click', function(event) {
    ...
    var key = '1f961992ec2e2db9112cf57ade593090';
    $.ajax({
...
function change_val(h, t, p, w) {
  $('#hum-two').html(h+ "%");
  $('#temp-one').html(t.toFixed(2)+ "&#8451;");
  $('#pressure-three').html(p+ " mbar");
  $('#wind-four').html(w+ " km/hr");
}
function temp(d) {
